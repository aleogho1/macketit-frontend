                      ...
                      <div className='self-stretch flex-col justify-start items-start gap-[7px] flex'>
                          ...
                          <Controller
                            ...
                            render={({ field }) => (
                              <Input
                                ...
                                {...field}
                                className={`grow shrink basis-0  rounded ${
                                  errors.posts_count?.message
                                    ? 'text-red-500'
                                    : 'text-primaryText'
                                } text-opacity-50 text-[12.83px] font-normal font-['Manrope']`}
                              />
                            )}
                            rules={{
                              required: true,
                        ...
                        <div className='self-stretch justify-center items-center gap-2 inline-flex'>
                          <div className="grow shrink basis-0 text-[10px] font-normal font-['Manrope']">
                            Enter the desired Number of Facebook Advert Post you
