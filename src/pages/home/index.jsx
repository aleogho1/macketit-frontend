    ...
    <>
      {userDetails ? (
        <div>
          <div className='p-3  flex-col justify-start items-start gap-3 inline-flex relative'>
                    ...
                    <Card className='self-stretch p-6 bg-gray-300 dark:bg-[#171717] justify-start items-start gap-[29px] inline-flex'>
                      <div className='grow shrink basis-0 flex-col justify-start items-start gap-2.5 inline-flex'>
                        ...
                        <div className="self-stretch text-black dark:text-zinc-300 text-xs font-normal font-['Manrope']">
                          ...
                          lets you showcase your expertise, interests, and
                          goals. 
                        </div>
                        <Button
                          startContent={
                    ...
                    <Card className='self-stretch p-6 bg-gray-300 dark:bg-[#171717] justify-start items-start gap-[29px] inline-flex'>
                      <div className='grow shrink basis-0 flex-col justify-start items-start gap-2.5 inline-flex'>
                        ...
                        <div className="self-stretch text-black dark:text-zinc-300 w-10/12 text-xs font-normal font-['Manrope']">
                          You need to link your social media accounts to
                          MacketIT³ before you can start earning. Click the
                          button below to link your social media accounts now.
                        </div>
                        <Button
            ...
            {performed_tasks?.length >= 1 ? (
              <div className='bg-[#3793FF] py-4 px-4 flex flex-col gap-y-4'>
                ...
                <div>
                  This is to remind you to ensure timely completion of your
                  current task before the time frame given for the task elapse
                  and only completion of a task guarantee payment. To complete
                  your pending task click on the button below.
                </div>
                <div
                  onClick={() => navigate('/dashboard/earn-history')}
                  className='flex items-center bg-white w-[131px] h-[36px] p-[8px] gap-x-2 text-black font-[700] text-[12px]'
                >
            ...
            <div className='mx-auto text-center md:mt-40 h-20 pb-3 flex-col justify-start items-center inline-flex'>
              ...
              <div className='py-3 justify-start items-center gap-[7px] inline-flex'>
                <div className="text-center text-black dark:text-zinc-300 text-sm font-medium font-['Manrope']">
                  © {new Date().getFullYear()} MacketIT MEDIA LTD.
                </div>
              </div>
            </div>
          </div>
          ...
          {isOpenVerify && (
            <SocialLinkOption isOpen={isOpenVerify} onClose={onCloseVerify} />
          )}
        </div>
      ) : (
        <div>
