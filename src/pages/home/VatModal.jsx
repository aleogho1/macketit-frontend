            ...
            <ModalContent className='overflow-visible'>
                <div className='p-6 rounded flex-col justify-center items-center gap-12 inline-flex'>
                    ...
                    <p className='text-[#B1B1B1] font-sm text-center'>
                        Please note that V.A.T charges of 1.5% would be deducted on every withdrawal transaction, to proceed  with this term click on the
                        continue button below
                    </p>      
                    <div className='flex items-center gap-x-4'>
                        <Button  className='bg-[#4CAF50] w-32 text-white' onClick={onOpenWithdraw}>
                            Continue
                        </Button>
